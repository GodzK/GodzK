<div align="center" style="background: linear-gradient(135deg, #0d1117 0%, #161b22 100%); padding: 40px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.5); border: 1px solid rgba(255, 255, 255, 0.1);">
  ...
  <div style="display: flex; justify-content: center; margin: 20px 0;">
    <img src="https://github-readme-streak-stats.herokuapp.com/?user=GodzK&theme=radical&hide_border=true&background=0D1117&stroke=00EAFF&ring=FF6BCB&fire=FF6BCB&currStreakNum=B0B8D6&sideNums=B0B8D6&currStreakLabel=00EAFF&sideLabels=00EAFF" alt="GitHub Streak" />
  </div>
